...
if __name__ == '__main__':
	...
	#get corpus
	lines_rdd = sc.textFile("s3n://AKIAJVNN43IYNE37I6XQ:fx5s7Fju9A8Xcb5lubS9m+tBwbc8HrTwUFhGpuNI@movielens-ryan/ml-20m/ratings.csv")
	...
	for i in range(num_cycle):
		...
		grad = ratings_rdd \
			.filter(lambda e: e[0][0]==i%num_workers) \
	...
	# 3 nodes, 30 s, 1.0 loss, 10 cycles, 10 sgd steps / cycle
